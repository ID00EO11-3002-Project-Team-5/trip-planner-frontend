  ...
  return (
    <div className="max-w-md mx-auto space-y-6">
      ...
      <div className="rounded border p-4 space-y-3">
        ...
        <input className="w-full rounded border px-3 py-2" value={name} onChange={e=>setName(e.target.value)} placeholder="Jordan Smith" />
        ...
        <label className="block text-sm font-medium mt-2">Confirm Password</label>
        <input type="password" className="w-full rounded border px-3 py-2" value={confirm} onChange={e=>setConfirm(e.target.value)} />

        <button className="w-full rounded bg-black text-white py-2 mt-3 text-sm">Create Account</button>
